...
//	private Properties mDeviceCrashInfo = new Properties(); 
    ...
    public static String filepath;//存储路径
    ...
    private CrashHandler() {
    	filepath = Util.getSDCardDir(MainApplication.INSTANCE) + XL_Log.LOG_PATH;
    }
    ...
    private boolean handleException(Throwable ex) {
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    Looper.prepare();
                    Toast.makeText(mContext, "很抱歉,程序出现异常,即将退出,请联系我们反馈问题", Toast.LENGTH_LONG).show();
                    Looper.loop();
                } catch (Throwable e) {
                    //捕捉内存崩溃
                }
