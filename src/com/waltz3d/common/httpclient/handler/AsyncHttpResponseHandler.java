...
import com.waltz3d.common.encrypt.CharsetConvert;
import com.waltz3d.common.httpclient.AsyncHttpClient;
...
public class AsyncHttpResponseHandler
{
    ...
    {
        sendMessage(obtainMessage(PROGRESS_MESSAGE, new long[] { total, loaded }));
    }
    ...
    public void sendResponseMessage(HttpResponse response)
    {
        ...
        if (200 != responseCode)
        {
            HttpResponseException exception = new HttpResponseException(status.getStatusCode(), status.getStatusCode() + " " + status.getReasonPhrase());
