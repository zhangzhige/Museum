...
package com.waltz3d.common.httpclient;
...
import com.waltz3d.common.httpclient.request.AsyncHttpRequest;
import com.waltz3d.common.httpclient.request.PersistentCookieStore;
import com.waltz3d.common.httpclient.request.RequestParams;
import com.waltz3d.common.httpclient.request.RetryHandler;
...
public class AsyncHttpClient
{
    ...
    private static final int DEFAULT_SOCKET_TIMEOUT = 40 * 1000;
    ...
    {
        HttpPost post = (HttpPost) newHttpMethod("Post", url, null);
        if(null == post) {
            responseHandler.sendFailureMessage(new IllegalArgumentException("the url is invlid."), "the url is invlid.");
            return;
        }
        sendRequest(httpClient, httpContext, addEntityToRequestBase(post, entity), contentType, responseHandler, context);
    }
    ...
    {
        HttpPost request = (HttpPost) newHttpMethod("Post", url, params);
        if(null == request) {
            responseHandler.sendFailureMessage(new IllegalArgumentException("the url is invlid."), "the url is invlid.");
            return;
        }
    ...
    public void post(Context context, String url, Header[] headers, HttpEntity entity, String contentType, AsyncHttpResponseHandler responseHandler)
    {
        ...
        HttpEntityEnclosingRequestBase request = addEntityToRequestBase(post, entity);
        if (headers != null)
            request.setHeaders(headers);
        sendRequest(httpClient, httpContext, request, contentType, responseHandler, context);
    }
    ...
    {
        HttpPut put = (HttpPut) newHttpMethod("Put", url, null);
        if(null == put) {
            responseHandler.sendFailureMessage(new IllegalArgumentException("the url is invlid."), "the url is invlid.");
            return;
        }
        
        sendRequest(httpClient, httpContext, addEntityToRequestBase(put, entity), contentType, responseHandler, context);
    }
    ...
    public void put(Context context, String url, Header[] headers, HttpEntity entity, String contentType, AsyncHttpResponseHandler responseHandler)
    {
        ...
        HttpEntityEnclosingRequestBase request = addEntityToRequestBase(put, entity);
        if (headers != null)
            request.setHeaders(headers);
        sendRequest(httpClient, httpContext, request, contentType, responseHandler, context);
    }
    ...
    public void delete(Context context, String url, AsyncHttpResponseHandler responseHandler)
    {
        ...
        HttpDelete delete = (HttpDelete) newHttpMethod("Delete", url, null);
        if(null == delete) {
            responseHandler.sendFailureMessage(new IllegalArgumentException("the url is invlid."), "the url is invlid.");
            return;
        }
    ...
    private HttpRequest newHttpMethod(String method, String url, RequestParams params)
    {
        HttpRequest q = null;
