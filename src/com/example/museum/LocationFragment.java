...
public class LocationFragment extends BaseFragment implements BaiduMap.OnMapClickListener,OnGetRoutePlanResultListener{
    ...
    public View onCreateContentView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mBtnPre = (Button) mRootView.findViewById(R.id.pre);
    ...
    public void SearchButtonProcess(View v) {
        ...
        mBaidumap.clear();
        // 处理搜索按钮响应
        EditText editSt = (EditText) mRootView.findViewById(R.id.start);
        EditText editEn = (EditText) mRootView.findViewById(R.id.end);
